...
import { Button, Card, Divider, CardBody, CardHeader, Spacer, Link, Spinner } from '@nextui-org/react';
      ...
      <div className="flex min-h-screen bg-gradient-to-b from-sky-900 to-slate-800">
        {isLoggedIn ? (
          <>
                          ...
                          <Dropdown>
                                ...
                                <DropdownMenu variant="faded" aria-label="Dropdown menu with icons">
                                  <DropdownItem
                                    key="new"
                                    shortcut="⌘N"
                                    startContent={<AddNoteIcon className={iconClasses} />}>Nowy wydatek</DropdownItem>
                                  <DropdownItem
                                    key="copy"
                                    shortcut="⌘C"
                                    startContent={<CopyDocumentIcon className={iconClasses} />}>Zaproś znajomego
                                  </DropdownItem>
                                  <DropdownItem
                                    key="edit"
                                    shortcut="⌘⇧E"
                                    startContent={<EditDocumentIcon className={iconClasses} />}> Edytuj rachunek
                                  </DropdownItem>
                                  <DropdownItem
                                    key="delete"
                                    ...
                                    color="danger"
                                    shortcut="⌘⇧D"
                                    startContent={<DeleteDocumentIcon className={cn(iconClasses, "text-danger")} />}>Usuń rachunek
                                  </DropdownItem>
                                </DropdownMenu>
                        </Dropdown>
            ...
            <div className="w-1/3 p-4">
            <Button as={Link} color="primary" href="/createBill" variant="flat"> Dodaj rachunek</Button>
